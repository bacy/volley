...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.android.volley.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.android.volley.db.table.Id>();

    /* package */
    static synchronized com.android.volley.db.table.Id getId(Class<?> entityType) {
        ...
        com.android.volley.db.table.Id id = new com.android.volley.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.android.volley.db.table.Id id = getId(entityType);
